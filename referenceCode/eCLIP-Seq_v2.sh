...
do
	...
	make_bigwig_files.py --dont_flip --bam ${pre}.rmRep.genome.sorted.r2.bam --genome $genomesize --bw_pos ${pre}.rmRep.genome.sorted.r2.norm.pos.bw --bw_neg ${pre}.rmRep.genome.sorted.r2.norm.neg.bw
	
    normalize_bedGraph.py --bg ${pre}.rmRep.genome.sorted.r2.pos.bg --bam ${pre}.rmRep.genome.sorted.r2.bam > ${pre}.rmRep.genome.sorted.r2.norm.pos.bg &
    normalize_bedGraph.py --bg ${pre}.rmRep.genome.sorted.r2.neg.bg --bam ${pre}.rmRep.genome.sorted.r2.bam > ${pre}.rmRep.genome.sorted.r2.norm.neg.bg &
    wait
